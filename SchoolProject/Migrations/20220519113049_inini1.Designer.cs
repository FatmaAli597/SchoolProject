...
namespace SchoolProject.Migrations
{
    ...
    [Migration("20220519113049_inini1")]
    partial class inini1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolProject.Models.Class", b =>
                {
                    ...
                    b.Property<int?>("courseScheduleDetailsID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("courseScheduleDetailsID");
            ...
            modelBuilder.Entity("SchoolProject.Models.ExamSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SchoolProject.Models.ExamScheduleDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SchoolProject.Models.Level", b =>
                {
                    ...
                    b.Property<int?>("examScheduleDetailsID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("examScheduleDetailsID");
            ...
            modelBuilder.Entity("SchoolProject.Models.Class", b =>
                {
                    ...
                    b.HasOne("SchoolProject.Models.CourseScheduleDetails", "courseScheduleDetails")
                        .WithMany()
                        .HasForeignKey("courseScheduleDetailsID");

                    b.Navigation("courseScheduleDetails");
            ...
            modelBuilder.Entity("SchoolProject.Models.ExamScheduleDetails", b =>
                {
                    ...
                    b.HasOne("SchoolProject.Models.ExamSchedule", "ExamSchedule")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolProject.Models.Level", b =>
                {
                    ...
                    b.HasOne("SchoolProject.Models.ExamScheduleDetails", "examScheduleDetails")
                        .WithMany()
                        .HasForeignKey("examScheduleDetailsID");
